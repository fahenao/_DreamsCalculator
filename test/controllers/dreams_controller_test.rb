...
class DreamsControllerTest < ActionController::TestCase
  ...
  test "should create dream" do
    assert_difference('Dream.count') do
      post :create, dream: { amount: @dream.amount, comments: @dream.comments, dream: @dream.dream, email: @dream.email, name: @dream.name, term: @dream.term }
    end
  ...
  test "should update dream" do
    patch :update, id: @dream, dream: { amount: @dream.amount, comments: @dream.comments, dream: @dream.dream, email: @dream.email, name: @dream.name, term: @dream.term }
    assert_redirected_to dream_path(assigns(:dream))
  end
